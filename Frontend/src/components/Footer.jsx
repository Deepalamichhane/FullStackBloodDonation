...
const Footer = () => {
  return (
    <div className="bg-gray-100 px-[100px]  text-gray-800 py-8">
      <div className="flex justify-between py-[5%]">
        <div>
          <img src="../public/logo.png" alt="" height={60} width={60} />
          <span className=" text-2xl font-bold font-serif">Bloodline Nepal</span>
        ...
        <div>
          ...
          <ul className="list-none">
            ...
            <li className="mb-2">
              <a href="#" className="flex items-center">
                <ChevronRight size={16} className="mr-2" /> Donors
              </a>
            </li>
            <li className="mb-2">
              <a href="#" className="flex items-center">
                <ChevronRight size={16} className="mr-2" /> Donation
              </a>
            </li>
            <li className="mb-2">
              <a href="#" className="flex items-center">
            ...
            <link to ="/login">
            <li li className="mb-2 pl-0"> 
              <a href="#" className="flex items-center">
                <ChevronRight size={16} className="mr-2" /> Admin
              </a>
            </li>
            </link>
          </ul>
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="w-12 h-1 bg-red-600 mb-4"></div>
          <p className="mt-2">Old Baneshwor, Kathmandu</p>
          <p className="mt-2">Phone: +123-456-7890</p>
          <p className="mt-2"> Email: info@bloodline.com</p>
        </div>
      </div>
